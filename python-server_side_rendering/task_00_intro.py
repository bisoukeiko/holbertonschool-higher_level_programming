...
def generate_invitations(template, attendees):
    ...
    for dict_attendee in attendees:
        ...
        invitation = invitation.replace('{event_title}', event_title if event_title else "N/A")
        invitation = invitation.replace('{event_date}', event_date if event_date else "N/A")
        invitation = invitation.replace('{event_location}', event_location if event_location else "N/A")
